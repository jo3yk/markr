...
- If the same student number is imported more than once with different firstName/lastName, the import fails with a 400 response. Note: this means that the provided sample_results.xml file fails.
